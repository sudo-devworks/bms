...
@section('title', 'Tambah Storage Backup')
@section('pageTitle', 'Tambah Storage Backup')
@section('pageSubtitle', 'Tambahkan lokasi penyimpanan backup baru.')
...
@section('content')
    <div class="mx-auto max-w-5xl space-y-6">
        ...
        <form action="{{ route('backup-storages.store') }}" method="POST" class="space-y-6">
            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div class="border-b border-slate-200 px-6 py-5">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Lengkapi informasi lokasi penyimpanan backup.
                    </p>
                </div>
