...
@section('title', 'Tambah Sistem Backup')
@section('pageTitle', 'Tambah Sistem Backup')
@section('pageSubtitle', 'Tambahkan sistem, aplikasi, database, atau layanan yang memiliki proses backup.')
...
@section('content')
    <div class="mx-auto max-w-5xl space-y-6">
            ...
            <div class="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <h1 class="mt-4 text-2xl font-bold tracking-tight text-slate-900">
                        Tambah Sistem Backup
                    </h1>

                    <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                        Daftarkan sistem yang memiliki proses backup. BMS hanya mencatat master data dan tidak menjalankan backup.
                    </p>
                </div>
        ...
        <form action="{{ route('backup-systems.store') }}" method="POST" class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            @csrf
